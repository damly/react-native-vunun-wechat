...
public class WeChatModule extends ReactContextBaseJavaModule {
    ...
    public static final String REACT_MODULE_NAME = "RNWeChat";
     ...
     */
    @ReactMethod
    public void registerAppWithDesc(String appId, String appdesc, Callback callback) {
        if (TextUtils.isEmpty(appId)) {
            if (callback != null) {
                callback.invoke("appId must be not null !");
            }
        ...
        if (WeChatModule.wxApi == null) {
            ...
            if (options == null) {
                ...
                if (options.hasKey(OPTIONS_TYPE)) {
                    ...
                    WXWebpageObject ob = (WXWebpageObject)msg.mediaObject;

                    Log.e(">>>>>>>>>>>>>",msg.title);
                    Log.e(">>>>>>>>>>>>>",req.scene+"");
                    Log.e(">>>>>>>>>>>>>",req.transaction+"");
                    Log.e(">>>>>>>>>>>>>",msg.description+"");
                    Log.e(">>>>>>>>>>>>>",msg.mediaTagName+"");
                    Log.e(">>>>>>>>>>>>>",ob.webpageUrl+"");
                    Log.e(">>>>>>>>>>>>>",ob.webpageUrl+"");
                    Log.e(">>>>>>>>>>>>>",thumbSize+"");
                    boolean sendReqOK = WeChatModule.wxApi.sendReq(req);
     ...
     */
    @ReactMethod
    public void sendLinkURL(String link, String tagName, String title, String desc,
                            String thumbImage, int scene, Callback callback) {

        WritableMap options = Arguments.createMap();

        options.putInt(OPTIONS_TYPE, TYPE_WEB_PAGE);
        options.putString(OPTIONS_TITLE, title);
        options.putString(OPTIONS_DESC, desc);
        options.putString(OPTIONS_TAG_NAME, tagName);
        options.putInt(OPTIONS_SCENE, scene);
        options.putInt(OPTIONS_THUMB_SIZE, 150);
        options.putString(OPTIONS_WEBPAGE_URL, link);
        options.putString(OPTIONS_THUMB_IMAGE, thumbImage);
